 ...
 * @author daisuke
 */
public final class JmPrimaryKeyConstraintStaxHandler extends StaxHandler<JmPrimaryKeyConstraint> {
	
	private static Logger logger = LoggerFactory.getLogger(JmPrimaryKeyConstraintStaxHandler.class);
	 ...
	 */
	public JmPrimaryKeyConstraintStaxHandler(StaxDirector director) {
		super(director);
	}
	
	@Override
	public JmPrimaryKeyConstraint handleDeserialization(DeserializationContext dctx) throws SerializationException {
		...
		try {
			...
			JmPrimaryKeyConstraint pk = new JmPrimaryKeyConstraint(id);
	...
	@Override
	public void handleSerialization(JmPrimaryKeyConstraint model, SerializationContext sctx)
