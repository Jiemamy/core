 ...
 * @author daisuke
 */
public final class JmNotNullConstraintStaxHandler extends StaxHandler<JmNotNullConstraint> {
	
	private static Logger logger = LoggerFactory.getLogger(JmNotNullConstraintStaxHandler.class);
	 ...
	 */
	public JmNotNullConstraintStaxHandler(StaxDirector director) {
		super(director);
	}
	
	@Override
	public JmNotNullConstraint handleDeserialization(DeserializationContext dctx) throws SerializationException {
		...
		try {
			...
			JmNotNullConstraint notNull = new JmNotNullConstraint(id);
			...
			do {
				...
				if (childCursor.getCurrEvent() == SMEvent.START_ELEMENT) {
					if (childCursor.isQName(CoreQName.NAME)) {
						...
						EntityRef<JmColumn> columnRef = EntityRef.of(referentId);
	...
	@Override
	public void handleSerialization(JmNotNullConstraint model, SerializationContext sctx) throws SerializationException {
