...
public enum SimpleJmDeferrability implements JmDeferrability {
	...
	/**
	 * {@link Deferrability}の値から {@link SimpleJmDeferrability}の値を引き当てる。
	 * 
	 * @param deferrability {@link Deferrability}の値
	 * @return 対応する {@link SimpleJmDeferrability}の値、見つからなかった場合は{@code null}
	 */
	public static SimpleJmDeferrability fromDeferrability(Deferrability deferrability) {
	 ...
	 * @return 対応する {@link SimpleJmDeferrability}の値
	 */
	public static SimpleJmDeferrability valueOf(boolean deferrable, InitiallyCheckTime initiallyCheckTime) {
		if (deferrable) {
	 ...
	 */
	SimpleJmDeferrability(boolean deferrable, InitiallyCheckTime initiallyCheckTime) {
