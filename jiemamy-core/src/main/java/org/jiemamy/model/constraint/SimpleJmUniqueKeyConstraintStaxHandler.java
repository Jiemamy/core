...
/**
 * {@link SimpleJmUniqueKeyConstraint}をシリアライズ/デシリアライズするハンドラ。
 * 
 * @version $Id$
 * @author yamkazu
 */
public final class SimpleJmUniqueKeyConstraintStaxHandler extends StaxHandler<SimpleJmUniqueKeyConstraint> {
	...
	@Override
	public void handleSerialization(SimpleJmUniqueKeyConstraint model, SerializationContext sctx)
