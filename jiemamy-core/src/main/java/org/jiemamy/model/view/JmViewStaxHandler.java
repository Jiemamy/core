...
/**
 * {@link JmView}をシリアライズ/デシリアライズするハンドラ。
 * 
 * @version $Id$
 * @author daisuke
 */
public final class JmViewStaxHandler extends StaxHandler<JmView> {
	
	private static Logger logger = LoggerFactory.getLogger(JmViewStaxHandler.class);
	 ...
	 */
	public JmViewStaxHandler(StaxDirector director) {
		super(director);
	}
	
	@Override
	public JmView handleDeserialization(DeserializationContext dctx) throws SerializationException {
	...
	@Override
	public void handleSerialization(JmView model, SerializationContext sctx) throws SerializationException {
