...
/**
 * {@link JmColumn}をシリアライズ/デシリアライズするハンドラ。
 * 
 * @version $Id$
 * @author daisuke
 */
public final class JmColumnStaxHandler extends StaxHandler<JmColumn> {
	
	private static Logger logger = LoggerFactory.getLogger(JmColumnStaxHandler.class);
	 ...
	 */
	public JmColumnStaxHandler(StaxDirector director) {
		super(director);
	}
	
	@Override
	public JmColumn handleDeserialization(DeserializationContext dctx) throws SerializationException {
	...
	@Override
	public void handleSerialization(JmColumn model, SerializationContext sctx) throws SerializationException {
