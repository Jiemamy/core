...
/**
 * {@link JmDomain}をシリアライズ/デシリアライズするハンドラ。
 * 
 * @version $Id$
 * @author yamkazu
 */
public final class JmDomainStaxHandler extends StaxHandler<JmDomain> {
	
	private static Logger logger = LoggerFactory.getLogger(JmDomainStaxHandler.class);
	 ...
	 */
	public JmDomainStaxHandler(StaxDirector director) {
		super(director);
	}
	
	@Override
	public JmDomain handleDeserialization(DeserializationContext dctx) throws SerializationException {
		...
		try {
			...
			JmDomain domain = new JmDomain(id);
	...
	@Override
	public void handleSerialization(JmDomain model, SerializationContext sctx) throws SerializationException {
