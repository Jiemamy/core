...
import org.jiemamy.model.column.JmColumnStaxHandlerTest;
...
/**
 * {@link JmViewStaxHandler}のテストクラス。
 * 
 * @version $Id$
 * @author daisuke
 */
public class JmViewStaxHandlerTest extends AbstractStaxHandlerTest {
	
	private static Logger logger = LoggerFactory.getLogger(JmColumnStaxHandlerTest.class);
	
	private static final SMOutputFactory F = new SMOutputFactory(XMLOutputFactory.newInstance());
	
	private StaxDirector director;
	
	private JmViewStaxHandler handler;
	...
	public void setUp() throws Exception {
		...
		handler = new JmViewStaxHandler(director);
	}
