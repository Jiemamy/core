...
/**
 * {@link SimpleJmView}のテストクラス。
 * 
 * @version $Id$
 * @author yamkazu
 */
public class SimpleJmViewTest {
	
	/**
	 * 適当な {@link SimpleJmView} のインスタンスを作る。
	 * 
	 * @return {@link SimpleJmView}
	 */
	public static SimpleJmView random() {
		SimpleJmView model = new SimpleJmView();
	...
	public void test01_create() throws Exception {
		try {
			...
			SimpleJmView unused = new SimpleJmView(null);
