 ...
 * @author daisuke
 */
public class SimpleJmTableStaxHandlerTest extends AbstractStaxHandlerTest {
	
	private static Logger logger = LoggerFactory.getLogger(SimpleJmTableStaxHandlerTest.class);
	...
	public void setUp() throws Exception {
		...
		handler = new SimpleJmTableStaxHandler(director);
	}
	...
	public void test01_簡単なテーブルを1つシリアライズして内容を確認する() throws Exception {
		...
		SimpleJmTable model = new SimpleJmTable(id);
