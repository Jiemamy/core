...
/**
 * {@link JmColumnStaxHandler}のテストクラス。
 * 
 * @version $Id$
 * @author daisuke
 */
public class JmColumnStaxHandlerTest extends AbstractStaxHandlerTest {
	
	private static final SMOutputFactory F = new SMOutputFactory(XMLOutputFactory.newInstance());
	
	private StaxDirector director;
	
	private JmColumnStaxHandler handler;
	...
	public void setUp() throws Exception {
		...
		handler = new JmColumnStaxHandler(director);
	}
	...
	public void test01_簡単なカラムを1つシリアライズして内容を確認する() throws Exception {
		...
		JmColumn model = new JmColumn(id);
		model.setName("foo");
