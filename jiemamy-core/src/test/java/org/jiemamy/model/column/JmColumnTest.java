...
/**
 * {@link JmColumn}のテストクラス。
 * 
 * @version $Id$
 * @author daisuke
 */
public class JmColumnTest {
	
	/**
	 * 適当な {@link JmColumn} のインスタンスを作る。
	 * 
	 * @return {@link JmColumn}
	 */
	public static JmColumn random() {
		JmColumn model = new JmColumn();
	...
	public void setUp() throws Exception {
		column = new JmColumn(UUIDUtil.valueOfOrRandom("a"));
	}
	...
	/**
	 * {@link JmColumn#toReference()}のテスト。
	 * 
	 * @throws Exception 例外が発生した場合
	 */
	@Test
