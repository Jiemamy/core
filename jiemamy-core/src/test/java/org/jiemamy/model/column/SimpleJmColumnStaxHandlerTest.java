 ...
 * @author daisuke
 */
public class SimpleJmColumnStaxHandlerTest extends AbstractStaxHandlerTest {
	...
	public void setUp() throws Exception {
		...
		handler = new SimpleJmColumnStaxHandler(director);
	}
	...
	public void test01_簡単なカラムを1つシリアライズして内容を確認する() throws Exception {
		...
		SimpleJmColumn model = new SimpleJmColumn(id);
		model.setName("foo");
