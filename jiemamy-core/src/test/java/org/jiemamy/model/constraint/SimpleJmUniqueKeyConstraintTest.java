...
/**
 * {@link SimpleJmUniqueKeyConstraint}のテストクラス。
 * 
 * @version $Id$
 * @author daisuke
 */
public class SimpleJmUniqueKeyConstraintTest {
	
	/**
	 * 適当な {@link SimpleJmUniqueKeyConstraint} のインスタンスを作る。
	 * 
	 * @param table 対象テーブル
	 * @return {@link SimpleJmUniqueKeyConstraint}
	 */
	public static SimpleJmUniqueKeyConstraint random(JmTable table) {
