...
/**
 * {@link JmUniqueKeyConstraint}のテストクラス。
 * 
 * @version $Id$
 * @author daisuke
 */
public class JmUniqueKeyConstraintTest {
	
	/**
	 * 適当な {@link JmUniqueKeyConstraint} のインスタンスを作る。
	 * 
	 * @param table 対象テーブル
	 * @return {@link JmUniqueKeyConstraint}
	 */
	public static JmUniqueKeyConstraint random(JmTable table) {
