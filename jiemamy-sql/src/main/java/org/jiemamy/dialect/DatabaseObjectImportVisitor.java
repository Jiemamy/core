...
/**
 * エンティティメタ情報から{@link JiemamyContext}にインポートを行うビジターインターフェイス。
 * 
 * @author daisuke
 */
public interface DatabaseObjectImportVisitor extends TypeSafeResultSetVisitor<TableMeta, Void, RuntimeException> {
