...
/**
 * {@link DatabaseMetaData}から{@link JiemamyContext}にインポートを行うビジターインターフェイス。
 * 
 * @author daisuke
 */
public interface DbObjectImportVisitor extends TypeSafeResultSetVisitor<TableMeta, Void, RuntimeException> {
	 ...
	 */
	void intialize(TypeSafeDatabaseMetaData meta, JiemamyContext context, ParseMetadataConfig config);
